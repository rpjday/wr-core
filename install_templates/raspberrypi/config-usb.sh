...
INSTALL_KERNEL="${ARTIFACTS_DIR}/Image"
INSTALL_ROOTFS="${ARTIFACTS_DIR}/cube-essential-raspberrypi2.tar.bz2"
INSTALL_MODULES=""
INSTALL_INITRAMFS="${ARTIFACTS_DIR}/cube-builder-initramfs-raspberrypi2.cpio.gz"
...
HDINSTALL_ROOTFS="${ARTIFACTS_DIR}/cube-essential-raspberrypi2.tar.bz2"

HDINSTALL_CONTAINERS="${ARTIFACTS_DIR}/cube-dom0-raspberrypi2.tar.bz2:console:vty=2:mergepath=/usr,essential \
                      ${ARTIFACTS_DIR}/cube-desktop-raspberrypi2.tar.bz2:monitored:console:vty=3:privileged:net=1:cube.admin=1:mergepath=/usr,essential,dom0 \
"
INSTALL_ROOTFS="${ARTIFACTS_DIR}/cube-essential-raspberrypi2.tar.bz2"
