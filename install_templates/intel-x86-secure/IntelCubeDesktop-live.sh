...
HDINSTALL_CONTAINERS="${ARTIFACTS_DIR}/cube-dom0-intel-corei7-64.tar.bz2:console:vty=2:net=3 \
                      ${ARTIFACTS_DIR}/cube-desktop-intel-corei7-64.tar.bz2:console:vty=3:net=1:cube.admin=1:cube.device.mgr=self:mounts=bind|/lib/modules|/lib/modules,mounts=bind|/lib/firmware|/lib/firmware \
"
